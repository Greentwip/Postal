...
//====================================================================
RSPIX_DECLSPEC extern	void rspAlphaBlit(
...
// also the most limited.
//====================================================================
RSPIX_DECLSPEC extern	void rspAlphaBlitT(
					RAlpha* pX,			// Set for current palette and alpha level
					RImage* pimSrc,	//	BMP8 source
					RImage* pimDst,	//	BMP8 destination
					int16_t sDstX,int16_t sDstY);
...
//									by it's COLOR - sheet of glass effect.
//====================================================================
RSPIX_DECLSPEC extern void rspGeneralAlphaBlit(
...
//
//====================================================================
RSPIX_DECLSPEC extern	void rspGeneralAlphaBlitT(
							int16_t sLevel,		// 0-255, 255 = unchanged
							RMultiAlpha* pX,	// for current palette
							RImage* pimMask,	// BMP8 alpha channel mask
							RImage* pimSrc,	// BMP8 source
...
//
//====================================================================
RSPIX_DECLSPEC extern	void rspFastAlphaBlitT(
...
//									by it's COLOR - sheet of glass effect.
//====================================================================
RSPIX_DECLSPEC extern	void rspFastMaskAlphaBlit(
...
//									the alpha mask (which could be useful)
//====================================================================
RSPIX_DECLSPEC extern	void rspFastMaskAlphaBlitT(
						uint8_t*** pfaX,		// A fast multialpha table	
						RImage* pimMask,	// BMP8 source alpha channel mask	
						RImage* pimSrc,	// BMP8 source		
						RImage* pimDst,	// BMP8 destination		
...
//====================================================================
RSPIX_DECLSPEC extern	void rspScaleAlphaMask(RImage* pimSrcMask, // BMP8 alpha mask
...
//====================================================================
RSPIX_DECLSPEC extern void rspMaskBlit(
					RImage* pimSrc,	// BMP8
					RImage* pimDst,
					int16_t sDstX,int16_t sDstY);
...
//====================================================================
RSPIX_DECLSPEC extern	void rspMakeMask(RImage* pimSrc,	// SOURCE AND DESTINATION
								  uint8_t ucVal);
//====================================================================
...
//====================================================================
RSPIX_DECLSPEC extern void rspCopyAsMask(
					RImage* pimSrc,
					RImage* pimDst,
					uint8_t ucVal);
