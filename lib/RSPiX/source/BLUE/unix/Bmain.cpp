...
void rspDoSystem(void)										// Returns nothing.
	{
        rspPresentFrame();
...
// 
//////////////////////////////////////////////////////////////////////////////
void rspSetDoSystemMode(	// Returns nothing.
...
//
////////////////////////////////////////////////////////////////////////////////
int16_t RSPIX_DECLSPEC rspGetQuitStatus(void)				// Returns TRUE if quit detected, FALSE otherwise
	{
	return ms_sQuit;
	}
...
//
////////////////////////////////////////////////////////////////////////////////
void rspSetQuitStatus(
	int16_t sStatus)										// In:  New status
	{
	ms_sQuit = sStatus;
	}

extern CMAIN_DECLSPEC int _argc;
extern CMAIN_DECLSPEC char **_argv;
