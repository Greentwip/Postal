...
RSPIX_DECLSPEC extern double SINQ[csNumRotSteps],COSQ[csNumRotSteps];
RSPIX_DECLSPEC extern float fSINQ[csNumRotSteps],fCOSQ[csNumRotSteps];
RSPIX_DECLSPEC extern int16_t ATANQ[60];
RSPIX_DECLSPEC extern int16_t SQRTQ[MAX_FAST_SQRT];
/****************************************************************/
...
RSPIX_DECLSPEC extern	int16_t rspATan(int16_t sDeltaY,int16_t sDeltaX);
RSPIX_DECLSPEC extern	int16_t rspATan(double dVal);
